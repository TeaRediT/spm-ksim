...
Практичне значення: Використання засобів BehaviorSearch дозволило автоматизовано знайти "критичні точки" кліматичної системи та змоделювати сценарії катастрофічного перегріву планети, які практично неможливо виявити шляхом несистематичного ручного підбору параметрів.
